...
<head>
    ...
    <title>Edit Equipment Item</title>
...
<body>
    ...
    <div class="form-container">
        <header>Equipment Defect</header>
            ...
            <div class="form-group">
                ...
                <div class="input-field">
                    ...
                    <select name="defect" id="defect" class="form-control">
                        ...
                        <option value="Broken" {{ $equipment->defect == 'Broken' ? 'selected' : '' }}>Broken</option>
                        <option value="Very Rusty" {{ $equipment->defect == 'Very Rusty' ? 'selected' : '' }}>Very Rusty
                        </option>
                        <option value="Loose Bearings" {{ $equipment->defect == 'Loose Bearings' ? 'selected' : '' }}>
                            Loose Bearings</option>
                        <option value="Torn Bands" {{ $equipment->defect == 'Torn Bands' ? 'selected' : '' }}>Torn Bands
                        </option>
                    </select>
                </div>
