...
@section('content')
    ...
    <body>
        <div class="main-wrapper">
            ...
            <div class="content-card">
                <div class="table-section">
                    <div class="mb-4">
                        <h1 class="card-title mb-0" style="font-size: 20px; font-weight: 500; color: #333;">Payment List
                        </h1>
                            ...
                            <tbody>
                                @forelse($payments as $payment)
                                    <tr>
                                        ...
                                        <td>
                                            <strong>{{ $payment->account_name ?? 'N/A' }}</strong>
                                        </td>
                                        <td>{{ $payment->reference_number ?? 'N/A' }}</td>
                                        <td>
                                            @if($payment->proof_of_payment_url)
                                                <a href="{{ url($payment->proof_of_payment_url) }}" target="_blank"
                                    ...
                                    <tr>
                                        <td colspan="9">
                                            <div class="empty-state">
                                                ...
                                                <p>There are no payment transactions to display</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
        ...
        <script>
            // Live search functionality for payment records
            document.addEventListener('DOMContentLoaded', function () {
