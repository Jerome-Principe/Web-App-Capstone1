                ...
                <div class="table-container">
                            ...
                            <tbody>
                                @foreach ($mobileFeedbacks as $index => $mobileFeedback)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge-clean badge-primary-clean">{{ $mobileFeedback->id}}</span>
                                        </td>
                                        <td>
                                            <strong>{{ $mobileFeedback->username}}</strong>
                                        </td>
                                        <td>
                                            <a href="mailto:{{ $mobileFeedback->email }}"
                                                style="color: var(--primary-color); text-decoration: none;">
                                                {{ $mobileFeedback->email }}
                                            </a>
                                        </td>
                                        <td>{{ $mobileFeedback->subject }}</td>
                                        <td class="message-cell">
                                            <div class="message-preview">
                                                {{ $mobileFeedback->message ?: 'No message' }}
                                            </div>
                                        </td>
                                        <td>
                    ...
                    @else
                        <div class="empty-state">
                            ...
                            <h3>No Mobile Feedback Found</h3>
                            <p>There are no mobile feedback entries to display at the moment.</p>
                        </div>
                    @endif
