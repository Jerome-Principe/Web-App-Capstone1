...
<body>
    ...
    <div class="summary">
        ...
        <div class="summary-info">
            ...
            <span>{{ $equipmentDefects->count() }}</span>
        </div>
        <div class="summary-info">
            <span>Total Quantity:</span>
            <span>{{ $equipmentDefects->sum('quantity') }}</span>
        </div>
    </div>
    ...
    <table>
        ...
        @if($equipmentDefects->count() > 0)
            <tfoot>
                <tr class="total-row">
                    <td colspan="3" class="total-label"><strong>Total Equipments Defect</strong></td>
                    <td class="total-amount"><strong>{{ number_format($equipmentDefects->sum('quantity')) }}</strong></td>
                </tr>
            </tfoot>
        @endif
    </table>
