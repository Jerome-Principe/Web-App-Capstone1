...
<body>
    ...
    <div class="summary">
        ...
        <div class="summary-info">
            ...
            <span>{{ $equipments->count() }}</span>
        </div>
        <div class="summary-info">
            <span>Total Quantity:</span>
            <span>{{ $equipments->sum('quantity') }}</span>
        </div>
    </div>
    ...
    <table>
        ...
        @if($equipments->count() > 0)
            <tfoot>
                <tr class="total-row">
                    <td colspan="2" class="total-label"><strong>Total Equipments</strong></td>
                    <td class="total-amount"><strong>{{ number_format($equipments->sum('quantity')) }}</strong></td>
                </tr>
            </tfoot>
        @endif
    </table>
