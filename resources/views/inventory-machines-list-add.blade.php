    ...
    <body>
        <div class="main-wrapper">
            ...
            <div class="page-header">
                <h1>Machines List</h1>
                <p>Monitor fitness machines and maintenance</p>
            </div>
                    ...
                    <div class="d-flex align-items-center gap-3 mb-2" style="justify-content: space-between;">
                        <div>
                            <h1 class="card-title mb-0" style="font-size: 20px; font-weight: 500; color: #333;">Machines
                                List</h1>
                            <p class="text-muted mb-0">Track and manage fitness machine inventory</p>
                        </div>
                        <div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="date-display">
                                            ...
                                            <span>{{ \Carbon\Carbon::parse($machine->date)->format('M d, Y') }}</span>
                                        </div>
                                    </td>
                                    <td class="text-center">
