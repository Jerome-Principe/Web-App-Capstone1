...
@section('content')
    ...
    <body>
        <div class="container">
            ...
            <div class="page-header">
                ...
                <p>Track custom member meal plans and dietary preferences</p>
            </div>
                ...
                <div class="header-section">
                    <div class="mb-4">
                        <div class="d-flex align-items-center gap-3 mb-2">
                            <h1 class="card-title mb-0">Meal Plan Custom List</h1>
                        ...
                        <p class="text-muted mb-0">Track custom member meal plans and dietary preferences</p>
                    </div>
                ...
                <div class="filter-options">
                    ...
                    <div>
                        <div class="d-flex align-items-center">
                            <form class="d-flex" role="search" method="GET" action="{{ route('meal-plan-custom.index') }}">
                                <input class="form-control" type="search" name="search"
                                    placeholder="Search custom meal plans..." aria-label="Search"
    ...
    <script>
        ...
        // Live search functionality for custom meal plans
        document.addEventListener('DOMContentLoaded', function () {
