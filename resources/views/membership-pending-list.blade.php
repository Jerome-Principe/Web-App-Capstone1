    ...
    <body>
        <div class="main-wrapper">
            ...
            <div class="page-header">
                ...
                <p>Review and manage pending membership applications</p>
            </div>
            ...
            <div class="content-card">
                <div class="table-section">
                    ...
                    <!-- Pending Memberships Table Section -->
                                ...
                                @forelse($pendingMemberships as $membership)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($membership->status === 'Declined')
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            <div class="empty-state">
                                                ...
                                                <h5>No pending memberships found</h5>
                                                <p>There are no pending membership applications to display</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                    ...
                                    <li class="page-item {{ !$pendingMemberships->hasMorePages() ? 'disabled' : '' }}">
                                        <a class="page-link" href="{{ $pendingMemberships->nextPageUrl() }}">
                                            Next
                                        </a>
                                    </li>
                                </ul>
