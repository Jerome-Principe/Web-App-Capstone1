        ...
        <form action="{{ route('feedback.update', $data->id) }}" method="POST">
            ...
            <div class="form-group">
                <div class="input-field">
                    ...
                    <input type="text" placeholder="Enter Name" id="name" name="name" value="{{ $data->name }}"
                        required>
                </div>

                <div class="input-field">
                    <label for="email">Email:</label>
                    <input type="email" placeholder="Enter Email" id="email" name="email" value="{{ $data->email }}"
                        required>
                </div>
