...
@section('content')
        ...
        <div class="container">
            ...
            <div class="filter-options">
                <div class="filter-links">
                    <a href="{{ route('feedback.index') }}">All ({{ App\Models\Feedback::count() }})</a>
                    <a href="{{ route('feedback.trashed') }}">Archived
                        ({{ App\Models\Feedback::onlyTrashed()->count() }})</a>
                </div>
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        @forelse($trashedFeedback as $feedbacks)
                            <tr>
                            ...
                            <tr>
                                <td colspan="7" class="text-center">
                                    <div class="empty-state">
                                        ...
                                        <h5>No archived feedback found</h5>
                                        <p>No feedback records have been archived yet</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
    ...
    <script>
        ...
        // Ensure the form doesn't submit if no feedback is selected
        document.getElementById('restore-selected-form').addEventListener('submit', function (e) {
            ...
            if (!selectedIds) {
                alert('Please select at least one feedback to restore.');
