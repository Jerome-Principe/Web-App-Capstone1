            ...
            <div class="filter-options">
                ...
                <div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <form class="d-flex" role="search" method="GET" action="{{ route('instructors.index') }}">
                            <input class="form-control" type="search" name="search" placeholder="Search instructors..." 
